...
给定一个子区域刨分$\mathcal{S}$，如何对$\mathcal{S}$进行一个预处理，可以使得我们快速确定一个点$q$的位置。
...
<center><img src="../06.assets/p1.png"></center>
...
<center><img src="../06.assets/p2.png"></center>
...
而对Slab算法的一个改进，就是使用Partially Persisten Structure。即对于每个Slab来说，视作同一个数据结构下不同历史时期的快照。简单来思考，就是扫描线从左向右扫描的时候，在每次中上一个Slab视为当前版本，来更新操作生成下一个版本时，任使用上一个Slab中部分数据。跟我们前面思考问题不谋而合。
...
**<font size = 4>Path Copying</font>**

<center><img src="../06.assets/p3.png"></center>
...
<center><img src="../06.assets/p4.png"></center>
...
**<font size = 4>Limited Node Copying</font>**
...
<center><img src="../06.assets/p5.png"></center>
...
<center><img src="../06.assets/p6.png"></center>
...
<center><img src="../06.assets/p7.png"></center>
...
<center><img src="../06.assets/p8.png"></center>
...
<center><img src="../06.assets/p9.png"></center>
...
**<font size = 4>Case 1: Two Endpoints</font>**

<center><img src="../06.assets/p10.png"></center>

左右两个端点都在一个梯形里面。这样一个梯形会分成四块。显然对于原来的梯形$X$，这个$X$要被替换成这四块上的一个搜索结构，搜所结构如右上角固定即可。


**<font size = 4>Case 2: One Endpoints</font>**

<center><img src="../06.assets/p11.png"></center>
...
**<font size = 4>Case 3: No Endpoints</font>**

<center><img src="../06.assets/p12.png"></center>
...
<center><img src="../06.assets/p13.png"></center>
